...
public class ProgressConsumerOne  {
    ...
    public void consumeMessage(String progressString) throws JsonProcessingException {
        ...
        System.out.println("Progress Consumer One +++++>>>  : Created On: " + progressEvent.getCreatedOn() + "Progress Activity Name " + progressEvent.getActivityName()+ "progress id " +progressEvent.getId());
    }
}
